...
<body>
    ...
    <form class="form-control" method="POST" action="/produto/atualizar/<?= $produto->getCodigo() ?>">
        ...
        <input type="text" value="<?= $produto->getImagem_url() ?>" name="imagem_url" class="form-control" />        
